<template>
	<view class="content">
		<view class="title"><text>索菲娅歼殛战</text></view>
		<view class="text-area">
			<view class="text-title"><text>在魔大陆阿济兹拉发现了新的亚拉戈神典石。据蛇心所说，使用这个古代记录媒体就可以挑战女神陷入失控状态的模拟战了。使用现实增强系统再现的与最高难度级别的女神索菲娅的战斗，一定充满了超乎想象的紧张感。光之战士们将挑战自己的极限，启动系统！</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/suofeiya90.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点：抑制绝境P1T6</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>登峰造极的女神索菲娅</text></view>
				...
				<view class="text-text-text"><text>前置任务：黄金色的灾厄</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>2.索菲娅</text></view> 
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/suofeiya94.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/suofeiya95.png" mode="aspectFit"></image></view>
