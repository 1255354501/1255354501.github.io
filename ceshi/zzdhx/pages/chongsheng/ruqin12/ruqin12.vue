<template>
	<view class="content">
		<view class="title"><text>巴哈姆特大迷宫入侵之章3</text></view>
		<view class="text-area">
			<view class="text-title"><text>启动拘束舰外围的传送装置之后，阿莉塞等人成功到达三号舰的内部，并且下到了3256星码的深处。可是距巴哈姆特沉睡的大空洞仍然有几千星码的距离。要在这复杂的通路中避开巡逻设备并且找到前进的路线，不是一般的困难。</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin120.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点：诸神黄昏级三号舰舰体中央</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>地图报箱数量：1</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>限制:</text></view> 
				<view class="text-text-text"><text>等级要求：50级</text></view>
				<view class="text-text-text"><text>装备品级要求：高于100</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>向深渊再次启程</text></view>
				...
				<view class="text-text-text"><text>前置任务：第七灵灾的真相</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>2. 降世化身</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin124.png" mode="aspectFit"></image></view>
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin125.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin126.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin127.png" mode="aspectFit"></image></view>
