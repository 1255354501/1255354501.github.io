<template>
	<view class="content">
		<view class="title"><text>巴哈姆特大迷宫 真源之章3</text></view>
		<view class="text-area">
			<view class="text-title"><text>地下8872星码，冒险者一行人来到了一片广阔的地下空间，巴哈姆特正在这里持续修复着自己的身体。正在阿莉塞准备前去关闭拘束舰的活动时，拦在他们面前的，是萨雷安首屈一指的大贤者——路易索瓦·莱韦耶勒尔。</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan30.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点： 诸神黄昏级六号舰第一舰桥</text></view>
			...
			<view class="text-text">
				<view class="text-text-title"><text>2. 不死鸟</text></view>
				<view class="text-text-text1"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan34.png" mode="aspectFit"></image></view>
				 
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan35.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan36.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan37.png" mode="aspectFit"></image></view>
