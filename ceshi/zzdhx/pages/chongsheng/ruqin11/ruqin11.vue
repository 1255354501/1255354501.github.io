<template>
	<view class="content">
		<view class="title"><text>巴哈姆特大迷宫入侵之章2</text></view>
		<view class="text-area">
			<view class="text-title"><text>阿莉塞等人突破了外围的艰苦环境，成功进入到拘束舰的外围部分。从这里进入内部的路会更加危险，他们所要面对的，是遍布合成兽等生体兵器的蓝光之路。</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin110.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点：拘束舰外围</text></view>
			...
			<view class="text-text">
				<view class="text-text-title"><text>2. 美瑠姬奴</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin114.png" mode="aspectFit"></image></view>
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin115.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin116.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/ruqin117.png" mode="aspectFit"></image></view>
