<template>
	<view class="content">
		<view class="title"><text>巴哈姆特大迷宫 真源之章4</text></view>
		<view class="text-area">
			<view class="text-title"><text>路易索瓦摆脱了巴哈姆特的控制，他用尽自己的力量为冒险者等人打开了通往最后一艘拘束舰的通路。长久的奋战终于即将迎来最后的高潮，为了达成路易索瓦贤者的遗愿，为了拯救艾欧泽亚的大地，光之战士与阿尔菲诺、阿莉塞兄妹二人毅然走向最后的战场……</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan40.png" mode="aspectFit"></image></view>
		   <view class="text-text">
		   	<view class="text-text-title"><text>基本信息:</text></view>
		   	<view class="text-text-text"><text>任务地点： 龙炎核心</text></view>
		   	...
		   	<view class="text-text-text"><text>超越之力：保持20%</text></view>
		   </view>
			<view class="text-text">
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>真相的碎片</text></view>
				...
				<view class="text-text-text"><text>前置任务：真相与决定</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>2. 至尊巴哈姆特</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan44.png" mode="aspectFit"></image></view>
				
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan45.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan46.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/zhenyuan47.png" mode="aspectFit"></image></view>
