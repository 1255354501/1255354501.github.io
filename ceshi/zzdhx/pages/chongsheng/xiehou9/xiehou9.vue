<template>
	<view class="content">
		<view class="title"><text>巴哈姆特大迷宫邂逅之章5</text></view>
		<view class="text-area">
			<view class="text-title"><text>在与亚拉戈古代兵器展开激战之后，阿莉塞一行人终于成功到达了地下1910星码的地区。而从空中飞舞下来“迎接”他们的，是一条佩戴有亚拉戈拘束装置的古代龙族……为了查明第七灵灾的真相，一定要突破一切阻碍前往更深的地方。光之战士们已经做好了战斗的觉悟。</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/xiehou90.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点：中枢区</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>装备品级要求：高于82</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>于里昂热沙之家X:6.1,Y:5.0</text></view>
				<view class="text-text-text"><text>前置任务：土神泰坦重现世间</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>2. 双塔尼亚</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/xiehou94.png" mode="aspectFit"></image></view>
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/xiehou95.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/xiehou96.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/xiehou97.png" mode="aspectFit"></image></view>
