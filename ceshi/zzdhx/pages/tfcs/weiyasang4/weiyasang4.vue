<template>
	<view class="content">
		<view class="title"><text>利维亚桑歼殛战</text></view>
		<view class="text-area">
			<view class="text-title"><text>鱼人族所召唤出来的水神利维亚桑被冒险者们所击败了，可是他们并没有就此服输。利用无影传授给他们的秘术，鱼人族举行了染满鲜血的仪式来召唤更强力的神明。</text></view><view class="text-title"><text>重新降临的水神得到了究极的力量，如果它这次成功引发出大海啸，后果会比之前严重几十倍。双体船必须立刻起航出发，再次平息大海的愤怒。</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/weiyasang40.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点：对利维亚桑双体船</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>装备品级要求：高于80</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>登峰造极的水神利维亚桑</text></view>
				...
				<view class="text-text-text"><text>前置任务：混沌的漩涡</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>2.利维亚桑</text></view>
				 
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/weiyasang44.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/weiyasang45.png" mode="aspectFit"></image></view>
