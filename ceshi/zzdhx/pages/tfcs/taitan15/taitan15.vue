<template>
	<view class="content">
		<view class="title"><text>泰坦歼灭战</text></view>
		<view class="text-area">
			<view class="text-title"><text>在究极神兵被破坏之后，各地的蛮族势力都开始再次召唤蛮神降临。威尔布兰德岛北部的地灵族自然也不会例外。以武伽玛罗武装矿山为首，地灵族的所有矿山都加快了开采水晶的速度。</text></view><view class="text-title"><text>威震大地的蛮神泰坦再次降临奥·哥摩罗火口神殿，只不过与之前不同的是，这次的泰坦更加愤怒，更加强大。</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/taitan150.png" mode="aspectFit"></image></view>
		    <view class="text-text">
				<view class="text-text-title"><text>基本信息:</text></view>
		    	<view class="text-text-text"><text>任务地点：奥·哥摩罗火口神殿</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>装备品级要求：高于57</text></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>土神泰坦重现世间</text></view>
				<view class="text-text-text"><text>战斗精英魔法导师50级</text></view>
				<view class="text-text-text"><text>雅·修特拉</text></view>
				<view class="text-text-text"><text>沙之家X:6.1,Y:5.2</text></view>
				<view class="text-text-text"><text>前置任务：风神迦楼罗重现世间</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text>2.泰坦</text></view>
				 
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/taitan154.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/taitan155.png" mode="aspectFit"></image></view>
