<template>
	<view class="content">
		<view class="title"><text>伊甸零式希望乐园共鸣之章3</text></view>
		<view class="text-area">
			...
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/gongming140.png" mode="aspectFit"></image></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>装备品级要求：高于480</text></view>
			...
			<view class="text-text">
				<view class="text-text-title"><text><strong>2.暗黑心象</strong></text></view>
				 
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/gongming144.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/gongming145.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/gongming146.png" mode="aspectFit"></image></view>
