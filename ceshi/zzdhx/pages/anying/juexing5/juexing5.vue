<template>
	<view class="content">
		<view class="title"><text>伊甸希望乐园觉醒之章3</text></view>
		<view class="text-area">
			<view class="text-title"><text>虽然受到了出乎意料的袭击，不过已经获得了伊甸控制权的一行人终于要开始为重新取回属性之力而行动起来。据于里昂热所说，最初应该激活的属性乃是所有生命之源的水属性之力。乘上伊甸的暗之战士们来到了第一世界曾经最深的海底，此处有着一条巨大的海沟——涅柔斯海渊，于里昂热利用暗之战士心中水神“利维亚桑”的形象进行了构想请神。挑战构想蛮神，激活水属性！</text></view>
			<view class="text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/juexing50.png" mode="aspectFit"></image></view>
			...
			<view class="text-text">
				...
				<view class="text-text-text"><text>涡动、再战</text></view>
				<view class="text-text-text"><text>战斗精英和魔法导师（除设限特职）80级</text></view>
				<view class="text-text-text"><text>琳</text></view>
				<view class="text-text-text"><text>伊甸内核X:23.5,Y:23.3</text></view>
				<view class="text-text-text"><text>前置任务：横空而来的黑暗</text></view>
			</view>
			<view class="text-text">
				<view class="text-text-title"><text><strong>2.利维亚桑</strong></text></view>
				
				<view class="text-text-text"><text>分摊伤害，躲避圈圈，喷水是大范围攻击记得角落躲避。第一次地震两边场地消失，第二次地震中间场地消失，场边出水柱会击退，记得防击退或者靠近水柱，大海啸的读条是全屏高伤，点名菊花会击退周围所有人，记得菊花去角落，其他人靠近他免得被击落。下阶段的俯冲不要被冲下去，躲避天空圆圈的直线。 中间场地消失不要用突进技能！！！！会掉下去！！！</text></view>
				<view class="text-text-title"><text>掉落战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/juexing54.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱1中的战利品:</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/juexing55.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱2中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/juexing56.png" mode="aspectFit"></image></view>
				<view class="" style="height: 80rpx"><text>宝箱3中的战利品：</text></view>
				<view class="text-text-pic"><image src="http://s1.catelyn.info/zjxcx/zzdhx/juexing57.png" mode="aspectFit"></image></view>
			</view>
