...
let datatime=[],pv=[],uv=[],ip=[];	
function test(data){
	var obj22=data
    obj22.data.forEach(function(i){
     	datatime.push(i.date.slice(5))
     	pv.push(i.pv)
     	uv.push(i.uv)
     	ip.push(i.ip)
     })     
...
var pageData = {
    ...
    'index': function indexData() {
		...
		var url="http://quickapp.bingo88.cn/loganalysis/loganalysis.php?callback=test"
        var script = document.createElement('script');
        script.setAttribute('src', url);
        document.getElementsByTagName('head')[0].appendChild(script); 
   //      $.ajax({ 
			// url: "http://quickapp.bingo88.cn/loganalysis/loganalysis.php", 
