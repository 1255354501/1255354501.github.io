	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你是哪个神仙的转世.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>轮回转世是种奇妙的说法，这一世成为人的我们，上一世说不准都是神仙的转世，那么你会是哪个神仙的转世呢？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"出门旅游时，你会制定旅游计划吗？","text":["会有详细的规划","有大致的规划","没有规划"],"checked":true},{"tltie":"在饮品店，你通常会购买哪类饮料？","text":["奶茶","果茶","碳酸饮料","咖啡"],"checked":true},{"tltie":"你结交的朋友大多数都是？","text":["周边的同学同事","年龄不一的网友","聊得来的同龄人"],"checked":true},{"tltie":"感觉自己负面情绪很多影响生活的时候，你会怎么做？","text":["出门旅行调整心情","找点好玩的事转移注意力","读书练字做手账平心静气","和朋友疯狂吐槽发泄出来"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你是哪个神仙的转世'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
