	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的甜品人格.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>一提到甜品，大多数人可能想到的是甜和软，但其实甜品分为好多不同的类别，也有着不同的个性特征，想知道你最像哪个甜品吗？快来测测吧~</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"如果你要被绑定一个穿越不同空间做任务的系统，你更想做下列哪种任务？","text":["当妈改变不孝孩子的命运","狂虐坏男人改变自己的命运","当坏配角促进男女主感情"],"checked":true},
					{"tltie":"每次你要进入任务的时候，会有一个声音提醒你，你觉得是什么样的声音？","text":["毫无感情的机器音","充满磁性的大叔音","毫无特色的男生声音","其他"],"checked":true},
					{"tltie":"系统允诺可以给你开一个金手指，你想要下列哪个？","text":["有一个自己的随身空间","可以听到别人的内心想法","在任务里获得或学到的东西实际生活也可以用"],"checked":true},
					{"tltie":"你在不断完成任务的过程中，发现始终有一个人变幻身份一直存在着，你觉得是？","text":["系统里的npc","可能是隐藏攻略任务","系统可能出故障了"],"checked":true},
					{"tltie":"你是女生还是男生？","text":["男生","女生"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的甜品人格'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
