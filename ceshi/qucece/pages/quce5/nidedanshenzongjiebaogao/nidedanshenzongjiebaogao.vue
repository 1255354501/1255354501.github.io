	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的单身总结报告.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>有些人桃花不断，有些人母胎solo，想知道你是哪种单身体质，为什么还单身吗？快来测测吧~</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你什么时候最想找对象？","text":["无时无刻","看到别人秀恩爱的时候","自己一个人无聊的时候","看到好看的小哥哥/小姐姐时"],"checked":true},{"tltie":"你更喜欢那种情侣相处模式？","text":["给对方留有自己的空间","时时刻刻都要黏在一起","向良师益友般共同进步","像小孩子一样打打闹闹"],"checked":true},{"tltie":"你是男生还是女生？","text":["男生","女生"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的单身总结报告'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
