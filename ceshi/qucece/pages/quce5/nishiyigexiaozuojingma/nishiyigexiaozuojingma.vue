	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你是一个小作精吗.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>“小作精”现在已经用来形容一些欢脱的小可爱，她们机灵古怪，招人喜爱。想知道你是一个小作精吗？快来测测看吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你如果参加选秀节目，会给自己立一个什么样的人设？","text":["柔软感性的团宠","甜美又性感","可爱但超努力","霸气敢拼但很温暖","低调但实力超强","臭脸但有反差萌"],"checked":true},{"tltie":"如果要在娱乐圈生存，你觉得除了实力外最不能缺少的一样东西是：","text":["好运气","性格魅力","强大的资源","给力的宣传"],"checked":true},{"tltie":"你觉得粉丝与偶像的关系是：","text":["相互鼓励","相互依靠","相互成就"],"checked":true},{"tltie":"你最不喜欢什么样的明星：","text":["实力配不上人气的","只做综艺还吹嘘实力的","人设与本人相差很大的","性格不讨人喜欢的","没有什么特别的标准"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你是一个小作精吗'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
