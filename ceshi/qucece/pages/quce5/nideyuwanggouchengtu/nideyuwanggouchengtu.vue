	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的欲望构成图.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>人都有欲望，有的人重感情，爱欲自然深重；有的人重事业，暴富欲重；有的人则清心寡欲甚至无欲无求。你的欲望构成是怎样的呢？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你期望的生活状态是：","text":["富足安逸，无波无澜","自由随性，坚持自己","激情挑战，刺激冒险","平淡美好，有小确幸"],"checked":true},{"tltie":"做事情遇到困难时，你的第一反应通常是：","text":["难受，逃避，不想做","车到山前必有路，总能解决的","不论如何一定要战胜它","先尝试解决，不能就放弃"],"checked":true},{"tltie":"和朋友或者恋人吵架冷战，你多久会原谅对方？","text":["看事情严重程度，气消了就原谅","一般对方给了台阶就结束冷战","没有隔夜仇，睡一觉就好了"],"checked":true},{"tltie":"最近三个月内你最想实现的愿望是？","text":["谈个甜甜的恋爱","小金库里的钱变多","变得开心一点","没啥愿望"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的欲望构成图'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
