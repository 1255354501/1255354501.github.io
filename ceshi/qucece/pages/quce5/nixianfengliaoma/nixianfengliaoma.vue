	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你闲疯了吗.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>大多数人都已经度过了很长一段无所事事的时间，有的人觉得自在还能再闲个十天八天，有的人却倍感折磨一秒钟都已经闲不住。想知道你闲疯了吗？快来测测看吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"家里的很多生活必需品快用完了，你会：","text":["那个用光了再出门买那个","一次性出门买完所有需要的物品","直接在网上下单等待次日送达"],"checked":true},{"tltie":"你能在无聊的日子里迅速给自己找到一些事情做吗？","text":["完全可以，可以找到很多好玩的事情做","不太可以，主要时长会犯懒","完全不可以，每天都是吃吃睡睡玩手机"],"checked":true},{"tltie":"如果现在可以用一样东西换你出门自由地玩耍1周，你会用什么去交换：","text":["手机","胖5斤","买的快递不发货","都不想换，我可以再宅7天！"],"checked":true},{"tltie":"无聊时你会约着朋友一起线上玩游戏吗？","text":["每天都在玩","经常约着玩","经常聊天但不怎么玩游戏","不怎么联系别人"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你闲疯了吗'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
