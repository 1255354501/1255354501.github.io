	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的攻受印象鉴定单.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>有的人自认天下无敌大强攻，在恋人眼里却是可爱的炸毛受；有的人自认自己是受，在朋友眼里却像个强攻。那么你在自己眼中、恋人眼中和朋友眼中的攻受印象会有多大差别呢？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你觉得自己是攻还是受？","text":["功","受","可攻可受"],"checked":true},{"tltie":"你在朋友眼里是一个怎样的人？","text":["值得信赖依靠的人","相处轻松没压力的人","细腻体贴不越界的人","积极向上带来快乐的人"],"checked":true},{"tltie":"一件你努力了很久却没能成功的事情，你会：","text":["痛快发泄情绪，投入心得目标","消沉一段时间，然后重整旗鼓","十分不甘心，就要死磕到底","耿耿于怀，不愿再次想起"],"checked":true},{"tltie":"你在恋爱里容易吃醋吗？","text":["是的，东亚小醋王","还行，偶尔会吃醋","基本不会，能给对方空间"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的攻受印象鉴定单'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
