	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的灵魂有多色.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>红色代表热情与力量，蓝色代表沉静与理性，不同的颜色代表着人性格中的不同特点和属性。那么你的灵魂到底有多少种颜色呢？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"如果人的精神世界有形态，你认为你的精神世界会是：","text":["一座小花园","广阔的森林","幽深的大海","没有边界的宇宙"],"checked":true},{"tltie":"如果人死后精神世界仍可以存在，你会选择什么作为你精神世界的载体？","text":["一块石头","一颗种子","一件饰物","一处沼泽"],"checked":true},{"tltie":"你的精神世界通过载体最终被另一个人发现，你希望这个人的身份是：","text":["战士","艺术家","学者","流浪汉"],"checked":true},{"tltie":"你的精神世界被再次打开后就发生了变化，你认为它会：","text":["逐渐消散","变成空壳","化为一方独立空间"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的灵魂有多色'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
