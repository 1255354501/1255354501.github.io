	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你最像武侠小说中的谁.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>从小到大，我们看了不少武侠小说和其改编的影视剧，对其中诸多人物至今仍印象深刻，想知道你最像武侠小说中的谁吗？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"如果可以得到一把刀，你会选择以下哪个？",
					"image":"http://s1.catelyn.info/zjxcx/qcc/jieguo/wxxs1.png",
					"text":["A","B","C","D","E","F"],"checked":true},
				{"tltie":"遇到比自己厉害还心狠手辣的对手，你会？","text":["凭自己的力量打败对方","借别人之手出掉对方","其他应对办法"],"checked":true},{"tltie":"你愿意为了练成绝世神功，放弃自己的爱情吗？","text":["愿意","不愿意"],"checked":true},{"tltie":"你是男生还是女生？","text":["男生","女生"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你最像武侠小说中的谁'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
