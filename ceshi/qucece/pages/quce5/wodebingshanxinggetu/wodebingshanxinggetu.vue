	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/我的冰山性格图.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>每个人都是有温度的，有的人如火焰，有的人如寒冰，有的人则是不温不火。那么你的冰山性格有多隐秘呢？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你最喜欢下列哪种花？","text":["紫色的薰衣草","火红的玫瑰","粉色的蔷薇","黄色向阳花","淡白的兰花"],"checked":true},{"tltie":"你觉得图中的云在哪个位置最和谐？","image":"http://s1.catelyn.info/zjxcx/qcc/jieguo/bsxg2.png","text":["1","2","3","4"],"checked":true},{"tltie":"以下童话情节里，哪个最让你困惑？","text":["睡美人为什么没有饿死","白雪公主到底有多美","长发公主的头发怎么洗"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/我的冰山性格图'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
