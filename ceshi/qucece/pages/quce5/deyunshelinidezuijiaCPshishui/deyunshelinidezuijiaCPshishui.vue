	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/德云社里你的最佳CP是谁.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>德云社的相声表演家喻户晓，给大家带来了不少欢乐，其中每个角儿的性格特点都各有不同，想知道德云社里你的最佳CP是谁吗？那就快来测测吧！~</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"下列相声大褂，你更喜欢哪一款？","image":"http://s1.catelyn.info/zjxcx/qcc/jieguo/dys1.png","text":["A","B","C","D"],"checked":true},
					{"tltie":"相声演员哪方面特质更吸引你？","text":["身段","声嗓","包袱"],"checked":true},{"tltie":"下列相声表演的内容，哪种更吸引你？","text":["唱小曲","演双簧","说贯口（比如报菜名）"],"checked":true},
					{"tltie":"你一般从哪个渠道看（听）相声？","text":["B站、优酷等视频平台","线下相声馆","喜马拉雅等音频平台"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						this.time=true
						this.list[index].checked=false
						let num=parseInt(Math.random()*1000)%8
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/德云社里你的最佳CP是谁'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
