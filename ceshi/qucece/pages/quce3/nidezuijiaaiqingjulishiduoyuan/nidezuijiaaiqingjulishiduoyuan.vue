	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的最佳爱情距离是多远？.jpg" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>“最佳交往距离”不仅存在于日常人际关系中，也存在与爱情关系中，想知道你的最佳恋爱关系是多远吗？快来测测吧~</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"你觉得一对恋人更像是：","text":["相互依缠的藤与蔓","两块刚好契合的拼图","两只频率相同的深海鲸鱼","两块慢慢互相打磨光滑的石头"],"checked":true},
					{"tltie":"一下恋人之间最不能让你忍受的事情是：","text":["每天都会发99+的消息","不管去哪里都要报备","限制对方的异性交友权利","意图纠正对方的三观"],"checked":true},
					{"tltie":"加入你约了朋友吃饭，你都已经到餐厅，ta缺因临时有事不能来，你会：","text":["买点吃的带回家吃","临时约其他朋友出来玩","自己一个人坐在那里用餐","不吃饭了，自己一个人出去嗨"],"checked":true},
					{"tltie":"以下这张图你最先看到的是：",
					"image":"http://s1.catelyn.info/zjxcx/qcc/aqjl4.png",
					"text":["条纹","波点","斑马","爱心"],"checked":true} ],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的最佳爱情距离是多远？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
