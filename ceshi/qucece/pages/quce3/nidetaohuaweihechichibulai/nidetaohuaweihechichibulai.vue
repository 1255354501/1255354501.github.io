	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的桃花为何迟迟不来？.jpg" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>很多人的桃花运一直不好，甚至没有桃花，其实这不一定是命理的问题，也有可能是自身经历导致的~~~~~想知道你的桃花运为何迟迟不来吗？快来测一测吧！</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"路遇一个让你不想见面的人，你觉得此人会是？","text":["你暗恋过的人","拒绝过你的人"],"checked":true},
				{"tltie":"如果让你现在的你去当尼姑/和尚，你会甘心吗？","text":["甘心，已经湿了","不甘心"],"checked":true},
				{"tltie":"对于恋人曾经的一切，你想知道吗？","text":["想","不想"],"checked":true},
				{"tltie":"心情不好或有烦恼的时候，你你更愿意：","text":["向他人倾诉","全部都憋在心里"],"checked":true},
				{"tltie":"如果刚入职某个岗位，遇到一些问题，你会如何解决、","text":["请教周围同事","翻看工作文档"],"checked":true},
				{"tltie":"一直撩你的小哥哥/姐姐，突然冷淡了，你会：","text":["主动联系一下","那就断了吧"],"checked":true},
				{"tltie":"你觉得你可以做家庭主妇/夫吗？","text":["不愿意","可以考虑"],"checked":true},
				{"tltie":"你的朋友圈多久没发过东西了：","text":["一个月以上","一个月以内"],"checked":true}
				],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的桃花为何迟迟不来？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
