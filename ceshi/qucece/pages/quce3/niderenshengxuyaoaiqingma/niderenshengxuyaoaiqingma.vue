	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的人生需要爱情吗？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>生活中我们常常如人饮水冷暖自知，爱情也一样，有些人无爱不欢，有些人却可爱可无。抛开世俗成见诚实自问：你的人生真的需要爱情吗？快来测测吧。</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"在恋人面前，什么时候你会暴露本性和缺点：","text":["一周~一个月","一个月~三个月","关系更进一步时（比如想结婚时）","紧急情况下（比如遇到情敌）"],"checked":true},
					{"tltie":"当你发现交往对象因“不再爱你”而有了分手意向的时候，你会？","text":["先发制人，率先踹了对方","诚恳沟通，体面分手","随心随缘，先提分手的人理亏，随Ta","侦探附体，探究自己是否被绿"],"checked":true},
					{"tltie":"为了和另一半维持亲密度，以下首先要做到的是：","text":["每天必须保持联系，聊天电话都行","每周必须有肢体接触，拥抱牵手都行","三观必须相近，灵魂要足够契合","亲密度不用刻意维持，对的人会相互吸引"],"checked":true},
					{"tltie":"对于“婚前需同居一年试爱再结婚”，你的看法是：","text":["没要，闪婚也挺浪漫的","没要，闪婚也挺浪漫的","有道理，自己应该会遵循","一年太少，至少两年起步","如果是真爱，那就想结婚就结"],"checked":true}
				],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的人生需要爱情吗？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
