	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/这辈子遇见真爱的几率有多大？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>有的人一眼万年，瞬间得到此生挚爱，也有人兜兜转转迷失方向，那么你这辈子能遇见自己的真爱么？几率有多大？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"你认为所谓的“真爱”应该是：","text":["真正的爱是霸占，摧毁，还有破坏","真正的爱如荆棘，是既粗暴有刺激的","真正的爱是包容、恒久的忍耐，又有恩赐","真正的爱并不一定是他人眼中的完美匹配，而是相爱的人彼此心灵的相互契合"],"checked":true},
					{"tltie":"在你看来，一段感情里不能缺少什么？","text":["陪伴","独立","信任","沟通","感动"],"checked":true},
					{"tltie":"假如你痛失所爱，你会用下面那种东西来疗愈自己？","text":["后悔药","忘情水","绝情丹","孟婆汤"],"checked":true},
					{"tltie":"下面几样东西，不管如何成长，你都不会丢弃的是什么？","text":["童真","反骨","真诚","善良"],"checked":true}
					 ],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/这辈子遇见真爱的几率有多大？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
