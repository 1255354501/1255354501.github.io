	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你的内心有多“丧”？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>生活重压之下，每个人或多或少都会有“丧气满满”的时刻，想知道你的丧气指数到底有多高吗？快来测测吧~</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"以下图片中你觉得哪张最“丧”","text":["","独自走在雪地上的人","独自在沙滩上留下脚印的人","空无一人的寂静公路"],"checked":true},{"tltie":"独自透过阁楼窗户王者天空的人","text":["发生以下那件事，你的心情会更受到影响？","被人说自己的新衣服难看","努力准备的考试得了低分","一直下雨不方便出门"],"checked":true},{"tltie":"喜欢的乐队突然宣布解散","text":["你对自己喜欢的事物，会有独占欲吗？","是的，难得遇到喜欢的东西，只想私藏","一般，遇到特别喜欢的东西才会想要独占","还好，会分享给愿意分享的人"],"checked":true},{"tltie":"没仔细想过","text":["你觉得凌晨两三点还在工作的人时因为什么？","失眠睡不着于是起来工作","精神亢奋，想耗尽精力","心情不好，相转移注意力"],"checked":true},{"tltie":"工作没做完，不想被老板抓把柄","text":[null,null,null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你的内心有多“丧”？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
