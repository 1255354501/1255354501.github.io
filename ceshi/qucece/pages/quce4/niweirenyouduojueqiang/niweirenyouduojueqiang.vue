	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你为人有多倔强？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>“当我和世界不一样，那就让我们不一样”，倔强地为自己发声，别成为他人嘴里说的人，成为自己。那么你为人有多倔强？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你做选择的时候回纠结吗？","text":["经常","偶尔","从不","岁寒三友“松竹梅”里，你认为谁最强？"],"checked":true},{"tltie":"松------常青不老，生机勃勃","text":["竹------铮铮铁骨，挺霜而立","梅------冰清玉洁，傲骨迎风","当你听到有人说“趁年轻，就要……”这样的话时，你认为？","对的，处于什么阶段就要做什么事"],"checked":true},{"tltie":"不同意，年龄不是问题，只要想做任何时候都不晚","text":["看情况吧","你更欣赏下面哪句话？","我不怪天不公，只恨我心不甘","螳臂趟车不可笑，只是倔强的挣扎"],"checked":true},{"tltie":"我一点都不强大，只是比弱者多了一丝倔强。","text":["每个人都是一个国王，在自己的世界里纵横跋扈。","事实上，柔弱的人往往倔强，正如刚毅的人往往豁达。",null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你为人有多倔强？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
