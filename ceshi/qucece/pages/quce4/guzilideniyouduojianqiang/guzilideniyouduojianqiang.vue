	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/骨子里的你有多坚强？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>没有人比你更了解你自己，那些成长路上的伤痛与不安，最终一定能得到消解和抚慰，你若不勇敢，谁替你坚强？骨子里的你有多坚强？快来测测吧！</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你觉得自己的心理年龄与生理年龄的关系是？","text":["心理年龄比生理年龄年轻","心理年龄比生理年龄成熟","两个年龄相差不多","看到【yizhi】，你会想到下面那个词语？"],"checked":true},{"tltie":"一致","text":["益智","意志","一只","你觉得“青春”是什么？"],"checked":true},{"tltie":"是真诚和热血，是再见和离别","text":["青春是一本太仓促的书","人在年轻的时候想成为任何人，除了自己","下面选项里，你最看重的是？","自由与快乐"],"checked":true},{"tltie":"金钱与成功","text":["理想与才华","情感与生活","为了缓解压力，你都会做些什么？","断舍离"],"checked":true},{"tltie":"哭卿卿","text":["放飞自我","化压力为食欲","其他",null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/骨子里的你有多坚强？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
