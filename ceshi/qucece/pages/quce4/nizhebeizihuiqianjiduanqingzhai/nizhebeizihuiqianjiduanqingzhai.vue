	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你这辈子会欠几段情债？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>心动仿佛一种玄学，总有人不知不觉就能搅乱别人的心，却撩而不自知，白白欠下一段段情债。想知道你有没有欠情债的潜力，又能欠下多少段情债呢？快来测测吧~</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你的桃花常常带给你：","text":["甜蜜与浪漫","机会与便利","麻烦与倒霉","此题超纲，我没有桃花"],"checked":true},{"tltie":"你的桃花突然变得特别旺，一周内有三个人对你表白，对此你的想法是：","text":["不愧是我！","真走桃花运了？","有点麻烦……","呵呵这不可能"],"checked":true},{"tltie":"以下描述，跟你符合的有：","text":["坚持垃圾入框，不乱扔垃圾","公共场合出入推拉门，会顺手给后边人多留几秒","和朋友在路上散步时，会主动走靠车道的外侧","出门自备纸巾或雨伞"],"checked":true},{"tltie":"衣着不一定精致品牌，但求整洁清爽","text":["有可用作展示的兴趣爱好或特长","","A．6条都符合","B．5条"],"checked":true},{"tltie":"C．3-4条","text":["D．0-2条","4．你会拒绝自己没啥感觉的追求者吗？","会，直截了当拒绝","会，委婉地冷处理"],"checked":true},{"tltie":"不会，可以了解试试","text":["不知道，没遇到过",null,null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你这辈子会欠几段情债？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
