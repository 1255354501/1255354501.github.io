	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你有多会盘？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>盘，可表喜爱可怒怼，旨在把-切内心想摸的东西搂在怀里摸他个地老天荒锃光瓦亮圆润饱满。那么你有多会盘?快来测测吧!</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"新的一年开始了，你准备?","text":["摩拳擦掌，大干一-番","洗心革面，重新做人","痛改前非，开始养生","继续躺平，做个咸鱼"],"checked":true},{"tltie":"","text":["2．走在摩肩接踵的人群中，你经常感到哪种情绪?","","安定","开心"],"checked":true},{"tltie":"迷茫","text":["烦躁","3．在舔狗的世界里，你只想做什么?","只做自己的舔狗","做一只特立独行的佩奇"],"checked":true},{"tltie":"做一只高贵冷艳的猫","text":["做没有感情的杀手","4．天也会觉得“做人没有什么意思”吗?","完全不会","还好，不太会"],"checked":true},{"tltie":"内心有点这么认为","text":["对啊，做人真的好没意思",null,null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你有多会盘？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
