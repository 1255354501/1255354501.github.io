	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你又多怂？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>有人认为:活着，可以哭，但不能怂;但也有人认为，偶尔的不坚强没什么可怕的，可以哭，也可以怂。那你知道自己是怂还是刚吗?快来测测吧!或许，会颠覆你的认知哦!</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"1．当别人询问你的意见的时，你爱用哪个词?","text":["可能","我觉得","你知道吗","说实话/讲真"],"checked":true},{"tltie":"其他","text":["2．你从小到大有过和上级顶嘴的经历吗?","没有","几次","很多次"],"checked":true},{"tltie":"3．你向喜欢的人表白被拒绝了，你会?","text":["瞬间很丧，挂在脸上","强颜欢笑","装作无事发生，尽快忘记","4．你心里难过时，会当着别人面掉眼泪?"],"checked":true},{"tltie":"是的","text":["不是","看情况","5．当你点了餐，却等了很久都没有上菜，发现老板忘了做你的餐，你会?","直接走掉"],"checked":true},{"tltie":"和老板理论","text":["告诉老板，让他尽快上餐，自己安心等待",null,null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你又多怂？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
