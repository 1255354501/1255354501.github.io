	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你的佛系指数有多高？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>“佛系青年”这个热刺席卷网络，指的是在快节奏的都市生活中，追求平和、淡然的生活方式的青少年人。所谓“佛系”，不过是一种极简的人生态度而已。快来测测你是不是传说中的佛系青年，佛系指数有多高呢？</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"从这张图你能看出什么？","text":["","未知的旅程","心灵的休息","平凡的道路"],"checked":true},{"tltie":"非凡的冒险","text":["独居的你半夜听到窗户外有奇怪的声音传来，你会？","出门查看是什么情况","打电话给好友/恋人/家人寻求帮助","装作没听见，继续做自己的事情"],"checked":true},{"tltie":"其他","text":["如果让你在孤岛生活3天，你最希望陪伴你的是哪个萌宠？","小猫","小狗","兔子"],"checked":true},{"tltie":"松鼠","text":["如果你需要减肥，会通过一下那种方式？","节食","运动","吃减肥药"],"checked":true},{"tltie":"其他","text":["如果一定要让你在朋友圈发一条带图的状态，你会？","发自己的自拍","精心挑选一张网图","发一张表情包"],"checked":true},{"tltie":"其他","text":[null,null,null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你的佛系指数有多高？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
