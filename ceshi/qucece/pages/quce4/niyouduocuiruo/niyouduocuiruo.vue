	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="/static/qcc/bankuai/你有多脆弱？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>有些人即便过得再艰难，依旧在外人面前咬紧牙关不示弱，只有独处时才会显露出脆弱的一面，让人看了满满的心疼!你有多脆弱呢?快来测测吧!</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"1．关系很一般的朋友来到你的城市游玩，发微信告诉你，想在你家住一天，你会:","text":["想个理由，婉言拒绝","不好意思拒绝，让对方住、","直接当做没看见","2．和朋友在一起时，是否也觉得心里空落落的?"],"checked":true},{"tltie":"有几次，心情非常低落","text":["没有，和朋友在一起都很开心","经常这样，开心不起来","3．你想向别人打听一件事，对方言辞闪避，你会?","追着问，会刨根问底"],"checked":true},{"tltie":"算了，不问了","text":["找个机会再问","4．计划好去一家有点远的餐厅吃饭，结果到地方才发现这家餐厅关门了，你会?","随便凑合吃一_段","在附近找找有没有别的好餐厅"],"checked":true},{"tltie":"心情不好，索性不吃回","text":[null,null,null,null],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='/static/qcc/jieguo/你有多脆弱？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
