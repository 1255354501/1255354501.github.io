	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你有多“缺心眼”？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>我们生活中一定也存在这么一群人，他们很直率，很单纯，甚至会给人一种“缺心眼”的感觉，和他们相处有时很轻松有时又很麻烦。那么，你的缺心眼指数有多高呢？测一下就知道！</text>
	...
	export default {
		data() {
			return {
				...
				subject:[  
					{
						tltie: '假如你正在看恐怖片，这时贞子从你的电视机爬了出来，你会：',
						text: [
							'立马关电视，让她卡在中间',
							'把她按回去/把她打一顿',
							'大叫一声就跑掉',
							 '抄起手边的东西就砸向电视机/把电视机砸坏掉',
							 ],
						checked: true,
					},{
						tltie: '你觉得下面的名字更适合图中的这个女性人物？',
						text: [
							'楚二妞',
							'苏翠花',
							 '尹三凤',
						...
						'image':"http://s1.catelyn.info/zjxcx/qcc/qxy2.png",
						checked: true,
					},{
						tltie: '多年不见的同学，突然给你发消息，在吗？你会回复？',
						text: [
							'在',
							'在忙，有什么事？',
							 '不回复',
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你有多“缺心眼”？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
