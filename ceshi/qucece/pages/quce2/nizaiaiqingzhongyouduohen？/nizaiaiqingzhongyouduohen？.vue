	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你在爱情中有多狠？.jpg" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>人在情场飘，哪有不挨刀?你在爱情中到底有多狠?是不羁的浪人，还是情场的狼人?快来测测吧!~</text>
	...
	export default {
		data() {
			return {
				...
				nickName:'',
				subject:[
					{"tltie":"假如你发现另一半有出轨的嫌疑，你会:","text":['翻查对方手机',"直接质问对方",'跟踪，现场逮人','趁早准备分手，这种人不值得'],"checked":true},
					{"tltie":"爱情对你来说更像是:","text":['一场博弈游戏','一种征服或臣服','一份成长','一个麻烦'],"checked":true},
					{"tltie":"假如你对自己的同事有好感，你会选择如何推进双方的关系?","text":['对方加班你也跟着加班','拼命工作，用优秀引起对方注意',"勤问工作上的问题，问完请客",'见缝插针地找对方聊天'],"checked":true},
					{"tltie":"如果觉察恋人有分手的征兆，你会选择:","text":["提前约谈对方，解开心结，补救--下","自己先提出分手,潇洒做甩人的一-方","暗中调查，搞清楚对方想分手的原因","放任自流，命里有时终须有，命里无时莫强求"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你在爱情中有多狠？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
