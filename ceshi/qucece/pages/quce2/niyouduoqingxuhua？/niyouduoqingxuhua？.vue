	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你有多情绪化？.jpg" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>你的日常情绪是稳定还是抽风?你的心是随风而动的帆帷还是八风不动的磐石?想知道你的情绪化指数有多高吗?快来测测吧~</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"你觉得自己日常更像:","text":["哈士奇","柴犬","布偶猫","鲸鱼"],"checked":true},{"tltie":"以下句子你更喜欢:","text":["精神病人思路广，智障儿童欢乐多。","谁终将声震人间，必长久深自缄默。","在左，疯子在右。","当你凝视深渊时，深渊也在凝视你。"],"checked":true},{"tltie":"这张图给你的感觉是:","text":["诡异、魔幻","深沉、平静","没太大感觉","其他"],"checked":true},{"tltie":"假如你的恋人劈腿被你当场发现，你的反应会是:","text":["直接上去给ta--耳光","远远给个不屑的眼神,毫无留恋地转身离开","偷偷拍照，发网上曝光渣人渣事","早就想甩了，省得自己动嘴"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你有多情绪化？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
