	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你的心理年龄有多大？.jpg" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>你的内心年龄是否和你的真实年龄有所差距，你是“小大人”还是“老小孩”，来测一测你的心理年龄就知道了！</text>
		...
		data() {
			return {
				...
				subject:[
					{
						"tltie":"如果要外出旅游，你通常是",
						"text":['早早就计划安排好一切','做个甩手掌柜，跟着同伴走','说走就走，不需要太多的计划和拖延'],
						'image':'http://s1.catelyn.info/zjxcx/qcc/xlnl1.png',
						"checked":true,
					},{
						"tltie":"假如现在给你一个机会学习某样乐器，你会选择？",
						"text":['钢琴','小提琴','吉他','其他'],
						'image':'',
						"checked":true},
					{
						"tltie":"下图中你最先注意得到的是",
						"text":['西瓜','风扇','游泳池的游泳圈','纱窗'],
						'image':'http://s1.catelyn.info/zjxcx/qcc/xlnl3.png',
						"checked":true,
					},{
						"tltie":"以下哪种情况和你最像？",
						"text":['我常被比我优秀的人吸引','我更喜欢去和喜欢我、尊敬我的人相处','我喜欢那些需要我的人'],
						'image':'',
						"checked":true,
					},{
						"tltie":"你更喜欢以下那个天空意境？",
						"text":['A','B','C','D'],
						'image':'http://s1.catelyn.info/zjxcx/qcc/xlnl5.png',
						"checked":true,
					}
				],
				list:[],
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你的心理年龄有多大？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
