	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你有多难驾驭？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>你足够剽悍吗?你的三观有多刚?你在别人眼中有多难搞定?快来测测你有多难驾驭吧!~</text>
	...
	export default {
		data() {
			return {
				...
				avatarUrl:'',
				nickName:'',
				subject:[{"tltie":"如果以下某项游乐场项目可以免费，你希望是:","text":["海盗船","碰碰车","过山车","摩天轮"],"checked":true},
				{
					"tltie":"你从下图中第一-眼看到的是:",
					"text":["树林","站立的人","恶魔的侧脸"],
					"image":"http://s1.catelyn.info/zjxcx/qcc/njy2.png",
					"checked":true},
				{"tltie":"假如你和很多朋友一起去度假村玩，你会选择加入以下哪项娱乐活动以融入集体氛围?","text":["聊天","打牌","散步","K歌"],"checked":true},{"tltie":"如果你拥有了可以读心的能力，你会想读以下哪类人的心?","text":["代表权威的公众人物","闪耀动人的偶像明星","你讨厌的人","你喜欢的人"],"checked":true}],
				list:[],
				radiotext:'',//暂存点击题目文字
				radiotop:'',//滚动高度
				jieguo:[]
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你有多难驾驭？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
