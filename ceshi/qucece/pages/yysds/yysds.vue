	...
	<view class="content"> 
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				...
				<view class="border" @click="xx()">
					<image src="http://s1.catelyn.info/zjxcx/qcc/bankuai/你会是《阴阳师》中的谁？.png" mode=""></image> 
				</view>
		...
		<view class="contpic" v-show="jieguosh"> 
			...
			<view class="txt">
				<view class="sanjiao"></view> 
				<view class="border">
					<text>《阴阳师》作为经久不衰的日式和风游戏，其美轮美奂的画风和精致细腻的角色都深受大家的喜爱，想知道你会是《阴阳师》中的谁吗?快来测测吧~</text>
		...
		data() {
			return {
				...
				subject:[
					{
						tltie:'你玩游戏时会跳过剧情吗?',
						text:['会，觉得浪费时间','会，觉得不重要','不会，觉得很有意思','不会，自己喜欢看'],
						checked:true 
					}, 
					{
						tltie:'如果你抽卡牌抽到了最好的卡牌，你会?',
						text:['非常开心并且分享给朋友看','一般开心..','没有什么感觉'],
						checked:true
					},
					{
						tltie:'3你会为了游戏去充钱吗?',
					...
					},
					{
						...
						tltie:'如果你特别特别喜欢游戏里的一个角色，你会?',
						text:['为ta充钱','去社交网站上跟喜欢ta的人一起交流','有时间都会去玩这个游戏'],
						checked:true
					} 
				],
				list:[],
			...
			radioclick(index){ 
				if(this.radiotext!=''){
					...
					if(index==this.subject.length-1){
						...
						this.jieguopic='http://s1.catelyn.info/zjxcx/qcc/jieguo/你会是《阴阳师》中的谁？'+(num+1)+'.png'
						uni.pageScrollTo({
						    scrollTop: 9999,
						    duration: 300
						});
